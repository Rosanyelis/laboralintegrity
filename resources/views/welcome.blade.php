            ...
            <header class="absolute top-0 left-0 right-0 z-20">
                <nav class="container mx-auto flex items-center justify-between p-6">
                    <div class="flex items-center gap-3">
                        ...
                        <h1 class="text-2xl font-bold text-white dark:text-white uppercase tracking-wider">Integridad Laboral</h1>
                    </div>
                    <div class="flex items-center gap-4">
                        <a class="px-4 py-2 text-sm font-medium text-white dark:text-white bg-transparent rounded-lg hover:bg-primary/10 dark:hover:bg-primary/20 transition-colors" href="#about-us">
                            Acerca de Nosotros
                        </a>
                        @if (Route::has('login'))
                            @auth

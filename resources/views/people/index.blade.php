...
<script>
    ...
    window.createIntegrity = function(person) {
        console.log('Creando integridad laboral para:', person);
        // Redirigir a la página de creación de integridad laboral con la persona preseleccionada
        window.location.href = `/work-integrities/create?person_id=${person.id}`;
    };

    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('recruiters.update', $recruiter) }}" id="recruiterForm">
                        @csrf
                        @method('PUT')

                        <!-- Hidden fields para IDs -->
                        <input type="hidden" name="company_id" id="company_id" value="{{ old('company_id', $recruiter->company_id) }}">
                        <input type="hidden" name="person_id" id="person_id" value="{{ old('person_id', $recruiter->person_id) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input type="date" name="registration_date" id="registration_date" 
                                       value="{{ old('registration_date', $recruiter->registration_date->format('Y-m-d')) }}"
                            ...
                            <div>
                                <label for="code_display" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    CÓDIGO
                                </label>
                                <input type="text" id="code_display" value="{{ $recruiter->code_unique }}" 
                        ...
                        <!-- Sección de Empresa -->
                        <div id="company_section" style="{{ $recruiter->company_id ? '' : 'display: none;' }}">
                            <div class="mb-6 p-6 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <!-- Información de empresa precargada -->
                                @if($recruiter->company)
                                <div class="mb-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                    <p class="text-sm text-blue-800 dark:text-blue-300">
                                        Empresa actual: <strong>{{ $recruiter->company->commercial_name }}</strong>
                                    </p>
                                </div>
                                @endif
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="text" id="business_name" 
                                               value="{{ $recruiter->company->business_name ?? '' }}"
                                               class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white bg-gray-100" 
                                               readonly>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="company_province" 
                                               value="{{ $recruiter->company->municipality->province->name ?? '' }}"
                                               class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white bg-gray-100" 
                                               readonly>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="company_municipality" 
                                               value="{{ $recruiter->company->municipality->name ?? '' }}"
                                               class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white bg-gray-100" 
                                               readonly>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="company_sector" 
                                               value="{{ $recruiter->company->sector ?? '' }}"
                                               class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white bg-gray-100" 
                                               readonly>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="company_phone" 
                                               value="{{ $recruiter->company->landline_phone ?? '' }}"
                                               class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white bg-gray-100" 
                                               readonly>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="company_extension" 
                                               value="{{ $recruiter->company->extension ?? '' }}"
                                               class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white bg-gray-100" 
                                               readonly>
                                    </div>
                        ...
                        <div class="mb-6 p-6 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            ...
                            <!-- Información de persona precargada -->
                            <div class="mb-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                <p class="text-sm text-blue-800 dark:text-blue-300">
                                    Representante actual: <strong>{{ $recruiter->person->name }} {{ $recruiter->person->last_name }}</strong>
                                </p>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="person_last_name" 
                                           value="{{ $recruiter->person->last_name }}"
                                           class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white bg-gray-100" 
                                           readonly>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="person_phone" 
                                           value="{{ $recruiter->person->cell_phone }}"
                                           class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white bg-gray-100" 
                                           readonly>
                                </div>

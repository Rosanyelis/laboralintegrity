    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('company.people.index') }}" class="bg-gray-600 hover:bg-gray-700 text-white font-medium py-1 px-3 rounded-lg transition-colors duration-200">
                    Volver a Consulta
                </a>
            </div>
        </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div x-show="activeTab === 'personal'">
                        <form action="{{ route('company.people.update-personal-info', $person) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                    ...
                    <div x-show="activeTab === 'residence'">
                        <form action="{{ route('company.people.update-residence-info', $person) }}" method="POST">
                            @csrf
                            @method('PATCH')
                    ...
                    <div x-show="activeTab === 'educational'" class="space-y-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                            ...
                            <form action="{{ route('company.people.educational-skills.store', $person) }}" method="POST" class="space-y-1">
                                @csrf
                                            ...
                                            @foreach($person->educationalSkills as $skill)
                                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                        <form action="{{ route('company.people.educational-skills.destroy', [$person, $skill]) }}" method="POST" class="inline-block delete-skill-form" data-skill-name="{{ $skill->career }}">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button 
                                                                type="submit"
                    ...
                    <div x-show="activeTab === 'work'" class="space-y-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                            ...
                            <form action="{{ route('company.people.work-experiences.store', $person) }}" method="POST" class="space-y-4">
                                @csrf
                                        ...
                                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                            @foreach($person->workExperiences as $experience)
                                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                        <form action="{{ route('company.people.work-experiences.destroy', [$person, $experience]) }}" method="POST" class="inline-block delete-experience-form" data-company-name="{{ $experience->company_name }}">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button 
                                                                type="submit"
                    ...
                    <div x-show="activeTab === 'references'" class="space-y-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                            ...
                            <form action="{{ route('company.people.personal-references.store', $person) }}" method="POST" class="space-y-4">
                                @csrf
                                        ...
                                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                            @foreach($person->personalReferences as $reference)
                                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                        <form action="{{ route('company.people.personal-references.destroy', [$person, $reference]) }}" method="POST" class="inline-block delete-reference-form" data-reference-name="{{ $reference->full_name }}">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button 
                                                                type="submit"
                    ...
                    <div x-show="activeTab === 'aspirations'">
                        <form action="{{ route('company.people.update-aspiration', $person) }}" method="POST">
                            @csrf
                            @method('PATCH')

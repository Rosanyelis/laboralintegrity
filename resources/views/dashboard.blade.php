            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-center">
                        ...
                        <h3 class="text-4xl font-bold text-gray-900 dark:text-white mb-2">{{ number_format($people_count) }}</h3>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-center">
                        ...
                        <h3 class="text-4xl font-bold text-gray-900 dark:text-white mb-2">{{ number_format($companies_count) }}</h3>

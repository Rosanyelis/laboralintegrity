@props([
    'searchRoute' => route('work-integrities.search-people'),
...
<div 
    x-data="{
        ...
        selectPerson(person) {
            ...
            {{ $xModel }}.dni = person.dni;
            {{ $xModel }}.previous_dni = person.previous_dni || '';
            {{ $xModel }}.birth_date = person.birth_date || '';
            {{ $xModel }}.birth_place = person.birth_place || '';
            {{ $xModel }}.province = person.province || '';
            {{ $xModel }}.municipality = person.municipality || '';
        },
    ...
    <div class="flex gap-2">
        ...
        <div class="relative flex-1">
            ...
            <input 
                ...
                x-model="search"
                @input="onSearchInput()"
                @focus="if(search.length >= 3) { searchPeople(); }"
